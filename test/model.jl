...
@testset "DeepONetModel" begin
	dparams = [
		(branch_dim = 2, trunk_dim = 3, output_dim = 4, act = [relu, sigmoid]),
		(branch_dim = 5, trunk_dim = 3, output_dim = 4, act = [relu, sigmoid]),
		(branch_dim = 2, trunk_dim = 5, output_dim = 4, act = [relu, sigmoid]),
		(branch_dim = 2, trunk_dim = 3, output_dim = 5, act = [relu, sigmoid]),
		(branch_dim = 2, trunk_dim = 3, output_dim = 4, act = [relu]),
	]
	sparams = [
		(branch_sizes = [2], trunk_sizes = [2], output_sizes = [2]),
		(branch_sizes = [2, 2], trunk_sizes = [2, 2], output_sizes = [2, 2]),
		(branch_sizes = [2, 3, 2], trunk_sizes = [2, 2], output_sizes = [2, 2]),
		(branch_sizes = [2, 2], trunk_sizes = [2, 3, 2], output_sizes = [2, 2]),
		(branch_sizes = [2, 2], trunk_sizes = [2, 2], output_sizes = [2, 3, 2]),
	]
	batches = [1, 10, 100]
